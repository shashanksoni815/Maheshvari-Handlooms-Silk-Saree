...
const seedData = async () => {
    try {
        ...
        const cat1 = await Category_1.default.create({ name: 'Maheshwari Silk', slug: 'maheshwari-silk', description: 'Authentic handloom Maheshwari silk sarees.' });
        const cat2 = await Category_1.default.create({ name: 'Kanjeevaram', slug: 'kanjeevaram', description: 'Traditional Kanjeevaram silk sarees.' });
        const cat3 = await Category_1.default.create({ name: 'Banarasi', slug: 'banarasi', description: 'Rich Banarasi brocade sarees.' });
